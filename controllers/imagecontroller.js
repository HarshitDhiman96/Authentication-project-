...
const fs = require("fs");
const cloudinary = require("../config_cloudinary/cloudinary");
...
const uploadImageController = async (req, res) => {
  try {
    ...
    console.log("File path:", req.file.path);// req.file.path indiactes the  file path comes from multer which stores fiels on upload folder locally
    const { url, publicId } = await uploadToCloudinary(req.file.path);

    //store the image url and public id along with the uploaded user id in database(mongodb)
